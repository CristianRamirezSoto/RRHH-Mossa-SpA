  ...
  async function handleSave(event) {
    ...
    try {
      ...
      setStatus(needsPatch
        ? 'Falta actualizar Supabase para fotos de perfil. Ejecuta supabase/sql/patches/profile.sql y vuelve a guardar.'
    ...
    <div className="page profile-page">
      ...
      <form className="panel profile-card" onSubmit={handleSave}>
        ...
        <section className="profile-consumption-card">
          ...
          <div>
            <strong>Tu perfil está protegido</strong>
            <p>La fotografía se optimiza antes de guardarse y solo las personas autenticadas pueden acceder a tu información.</p>
          </div>
